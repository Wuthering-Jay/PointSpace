...
# 0. Path settings
# -------------------------------------------------------
train_data_dir = r"E:\data\铁二院\第二批\new\nl\tile\train"
val_data_dir = r"E:\data\铁二院\第二批\new\nl\tile\val"
test_data_dir = r"E:\data\铁二院\第二批\new\nl\tile\val"
pred_save_dir = r"E:\data\铁二院\第二批\new\nl\tile\pred"
save_path = "exp/铁二院/semseg-pt-v2m4-0"
...
# -------------------------------------------------------
# weight = "exp/铁二院/semseg-pt-v2m4-0/model/model_last.pth"  # path to pretrained / fine-tune weight
weight = None
...
data = dict(
    ...
    train=dict(
        ...
        class_weight=None,           # Recommended: sqrt method
