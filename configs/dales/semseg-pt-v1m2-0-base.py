...
save_path = "exp/dales/semseg-pt-v1m0-0-base"
...
# -------------------------------------------------------
weight = "exp/dales/semseg-pt-v1m2-0-base/model/model_last.pth"   # path to pretrained / fine-tune weight
# weight = None
...
model = dict(
    ...
    backbone=dict(
        ...
        enc_strides=(1, 4, 4, 4),
        enc_nsamples=(24, 32, 32, 32),
        dec_depths=(1, 1, 1, 1),
        dec_channels=(24, 48, 96, 192),
        dec_nsamples=(24, 32, 32, 32),
        share_planes=8,
        attn_drop_rate=0.0,
        drop_path_rate=0.3,
