...
save_path = "exp/dales/semseg-deeplanet-v1-0"
...
# -------------------------------------------------------
weight = "exp/dales/semseg-deeplanet-v1-0/model/model_last.pth"   # path to pretrained / fine-tune weight
# weight = None
...
model = dict(
    ...
    backbone=dict(
        ...
        enc_depths=(2, 2, 6, 2),
        enc_channels=(24, 64, 128, 256),
        enc_neighbours=(16, 16, 16, 16),
        dec_depths=(1, 1, 1, 1),
        dec_channels=(24, 64, 128, 256),
