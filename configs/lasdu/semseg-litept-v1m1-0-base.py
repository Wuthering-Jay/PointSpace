...
save_path = "exp/lasdu/semseg-litept-v1m1-0-base"
...
# -------------------------------------------------------
weight = "exp/lasdu/semseg-litept-v1m1-0-base/model/model_last.pth"   # path to pretrained / fine-tune weight
# weight = None
...
# -------------------------------------------------------
batch_size_train = 48      # effective batch = micro_batch × gradient_accumulation_steps
...
gradient_accumulation_steps = 1  # effective batch = 2, micro_batch per step = 3
